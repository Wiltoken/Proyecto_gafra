...
switch ($tipo_usuario) {
    case 'operario_corte':
    case 'operario_ensamble':
    case 'operario_tuberia';
    case 'operario_satelite';
        // No hacer nada aquí, la verificación se realiza para ambos tipos de operarios
        break;
    default:
        // Redirigir a una página de acceso no autorizado si el tipo de usuario no es válido
...
<style>
    ...
    #lateral {
        ...
        border-radius: 10px;
        margin-bottom: 20px;
        margin-left: 10%; /* Ajusta el margen izquierdo */
    }
    ...
    #menu {
        ...
        margin-bottom: 20px;
        padding: 5px;
        top: 50%; /* Coloca el menú en el 50% de la altura de la página */
        left: 50%; /* Coloca el menú en el 50% del ancho de la página */
        transform: translate(-50%, 0%); /* Centra el menú correctamente */
    }
    ...
    .custom-button {
        width: calc(33% - 40px); /* Distribuir el espacio equitativamente */
    ...
    footer {
        ...
        z-index: 998; /* Asegura que el footer esté por encima del menú */
    }
    ...
    <div class="user-info-container">
        ...
        <div  class="datos_usuario">
            ...
            <div>
                ...
                <?php } else { ?>
                <p>No se encontraron datos de usuario en la sesión.</p>
                <?php } ?>
            </div>
        </div>
        <h1>Operario</h1>
